...
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>${empty editUser?'添加用户':'编辑用户'} - 微订宝衣橱</title><link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin.css"></head><body>
<header class="admin-top"><h2>后台管理</h2><ul><li><a href="${pageContext.request.contextPath}/admin/dashboard">控制面板</a></li><li><a href="${pageContext.request.contextPath}/admin/clothes">服装管理</a></li><li><a href="${pageContext.request.contextPath}/admin/orders">订单管理</a></li><li><a href="${pageContext.request.contextPath}/admin/users" class="active">用户管理</a></li><li><a href="${pageContext.request.contextPath}/clothes">返回前台</a></li></ul></header>
<div class="admin-main"><h1>${empty editUser?'添加用户':'编辑用户'}</h1><a href="${pageContext.request.contextPath}/admin/users" style="color:#a08070;font-size:13px">&larr; 返回用户列表</a>
<div class="form-sheet" style="margin-top:18px"><form action="${pageContext.request.contextPath}/admin/users" method="post">
