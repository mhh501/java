...
import com.pyh1.entity.OrderItem;
        ...
        try {
            ...
            try (PreparedStatement ps = conn.prepareStatement(itemSql)) {
                for (Cart item : cartItems) {
                    ...
                    // Use cart price (may be size-specific), fall back to clothes base price
                    double orderPrice = item.getPrice() > 0 ? item.getPrice() : item.getClothesPrice();
