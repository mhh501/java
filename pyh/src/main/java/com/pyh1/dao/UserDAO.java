...
public class UserDAO {
    ...
    public User login(String username, String password) {
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) return rowToUserFull(rs);
            }
    ...
    // rowToUser: used for listing/display -- does NOT load password
    ...
    // rowToUserFull: used ONLY for authentication -- includes password
    private User rowToUserFull(ResultSet rs) throws SQLException {
        User u = rowToUser(rs);
